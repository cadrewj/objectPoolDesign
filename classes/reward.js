...
export class SelectReward extends Reward{
...
export class Food extends Reward{
...
export class Oxygen extends Reward{
  constructor(game, x, y){
    super(game);
    this.game = game
    this.type = "oxygen";
...
export class Minerals extends Reward{
  constructor(game, x, y){
    super(game);
    this.game = game
    this.type = "mineral";
...
export class PhantomTriangle extends Reward{   
  constructor(game, x, y){
    super(game);
    this.game = game;
  ...
  isCollidingWithTriangle(triangle) {
    ...
    return true; // otherwise it is Colliding
  }     
}
